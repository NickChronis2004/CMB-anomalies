...
$\alpha$ & $3.5 \pm 1.4$ & --- \\
$k_c\;[\mathrm{Mpc}^{-1}]$ & $0.00050^{+0.00062}_{-0.00045}$ & --- \\
$H_0\;[\mathrm{km\,s^{-1}\,Mpc^{-1}}]$ & $67.27 \pm 0.60$ & $67.36 \pm 0.54$ \\
$\Omega_b h^2$ & $0.02236 \pm 0.00015$ & $0.02237 \pm 0.00015$ \\
$\Omega_c h^2$ & $0.1202 \pm 0.0014$ & $0.1200 \pm 0.0012$ \\
$\tau$ & $0.054 \pm 0.005$ & $0.054 \pm 0.007$ \\
$10^9 A_s$ & $2.101 \pm 0.025$ & $2.100 \pm 0.030$ \\
$n_s$ & $0.9650 \pm 0.0042$ & $0.9649 \pm 0.0042$ \\
\bottomrule
\end{tabular}
...
The best-fit CCR model achieves $\chi^2_{\min} = 1002.6$, with best-fit
parameters $\log_{10}(\ln D) = 15.7$ and $\alpha = 4.1$. This best-fit
point lies in the $\Lambda$CDM-like regime
($\ln D \simeq 5.6 \times 10^{15}$, corresponding to
$k_c \simeq 3.1 \times 10^{-5}\;\mathrm{Mpc}^{-1}$), where the suppression
...
This value indicates no meaningful preference for either model on the Jeffreys scale ($|\ln B| < 1$).
...
(i)~the MCMC best-fit (log$_{10}(\ln D) = 15.7$, $\alpha = 4.1$), which lies
...
multipoles, with a maximum fractional deviation of $< 10^{-2}$.
